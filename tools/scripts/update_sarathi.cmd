...
echo.
echo ------------------------------------------------------------------------
echo Provisioning Krutrim-Translate (4096 Context, Canonical Engine)
echo ------------------------------------------------------------------------
set "TOKEN_PARAM="
...
echo.
echo [*] Running Translation model provisioning (Krutrim-Translate)...
"%PS_EXE%" -NoProfile -ExecutionPolicy Bypass -File "%~dp0Setup-TranslationModels.ps1" -Engine krutrim !TOKEN_PARAM!
goto AFTER_OP
...
echo.
echo ========================================================================
echo [*] Step 3/3: Provisioning Translation Models (Krutrim-Translate)...
echo ========================================================================
"%PS_EXE%" -NoProfile -ExecutionPolicy Bypass -File "%~dp0Setup-TranslationModels.ps1" -Engine krutrim
goto AFTER_OP
