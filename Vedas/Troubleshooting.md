...
| **Translation** | `Missing model asset` or SentencePiece error | Unprovisioned CTranslate2 weights | Run translation provisioner: `powershell -ExecutionPolicy Bypass -File tools\scripts\Setup-TranslationModels.ps1 -Engine indictrans2` |
