...
| `shakti/bank_statements/consolidator.py` | Consolidator and Canonical Output Exporter for Bank Statements | **In-Memory / Polars Columnar** | `consolidate_statements()`, `build_parquet_artifact()`, `build_accounts_xlsx_artifact()`, `build_transactions_xlsx_artifact()` |
