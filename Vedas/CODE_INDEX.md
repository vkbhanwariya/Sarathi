...
| `shakti/bank_statements/bank_registry.py` | Canonical Indian Bank Master Registry for Sarathi | **In-Memory / Polars Columnar** | `BankInfo`, `BankRegistry`, `get_bank_registry()` |
...
| `shakti/bank_statements/consolidator.py` | Consolidator and Canonical Output Exporter for Bank Statements | **In-Memory / Polars Columnar** | `consolidate_statements()`, `build_parquet_artifact()`, `build_accounts_xlsx_artifact()`, `build_transactions_xlsx_artifact()`, `build_xlsx_artifact()` |
...
| `shakti/bank_statements/utr_repair.py` | Banking Identifier Syntax Extraction, OCR Auto-Repair, and Balance Integrity | **In-Memory / Polars Columnar** | `is_valid_ifsc()`, `repair_ifsc()`, `repair_utr()` |
