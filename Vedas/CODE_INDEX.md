...
| `shakti/ocr/engine/rasterize.py` | Document page rasterization and image extraction for OCR | **Primary iGPU (OpenVINO FP16)** | `BoundedPageRasterizer`, `get_page_count_from_bytes()`, `extract_single_page_image()`, `iter_images_from_bytes()`, `extract_images_from_bytes()` |
