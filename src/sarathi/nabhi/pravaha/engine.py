...
from sarathi.nabhi.pravaha.lifecycle import (
    execute_manual_retry as _execute_manual_retry,
)
...
class Pravaha:
    ...
    def manthan(self) -> Manthan:
        """Return the injected Manthan planning service."""
        return self._manthan

    @property
    def yantra(self) -> Yantra:
        """Return the injected Yantra execution supervisor."""
        return self._yantra
    ...
    def registry(self) -> Kosh:
        """Return the injected Kosh registry."""
