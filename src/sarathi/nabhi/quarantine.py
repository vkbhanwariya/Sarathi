...
class LifecycleAction:
    ...
    def __post_init__(self) -> None:
        ...
        if self.prior_result is not None and not isinstance(self.prior_result, Result):
            raise TypeError(f"prior_result must be a Result instance or None, got {type(self.prior_result).__name__}.")
