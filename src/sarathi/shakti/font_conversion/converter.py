...
# In Remington: uppercase letters D, P, R, F, Y, O, L, C, H, E, U, I, X, T are half-consonants (क्, च्, त्, थ्, ल्, व्, स्, ब्, भ्, म्, न्, प्, ग्, ज्)
# Lowercase letters d, x, p, t, V, B, M, r, n, u, c, ;, j, y, o, ?, g, h, K, s, e are base consonants (क, ग, च, ज, ट, ठ, ड, त, द, न, ब, य, र, ल, व, ?, घ, ह, ज्ञ, स, म)
_KRUTI_HALF_CONSONANTS = r"(?:[DPRFYOCLHUIXT\xb6\xd9\xe8\xa6\x27\u2018\u2019\u201c\u201d]|E(?!$)|x~|\{|\&|J~|\.)"
_KRUTI_BASE_CONSONANTS = r"(?:\[k|\?k|Fk|/k|Hk|'k|\"k|\.k|\{k|[\u2018\u2019\u201c\u201d]k|\xd9k|\xe8k|[ldixptTVBMrnuc;jyo\?ghKsQeJK\xe7\xe4\xf1\xf2\xf3\xf4\xf5\xf6\xf7\xf8\xf9\xfa\xfb\xfc\xfd\xfe=\}\xd8\)])"
