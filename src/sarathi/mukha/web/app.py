...
def create_mukha_app(mukha: MukhaWebServer) -> Starlette:
    ...
    async def app_js(_: Request) -> Response:
        return _static_response("app.js", "application/javascript")

    async def js_asset(request: Request) -> Response:
